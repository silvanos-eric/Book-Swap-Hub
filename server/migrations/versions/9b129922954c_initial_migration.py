...
Revision ID: 9b129922954c
Revises: 
Create Date: 2024-10-20 06:26:51.861856
...
def upgrade():
    ...
    sa.Column('name', sa.Enum('seller', 'customer', name='role_type'), nullable=False),
