...
Revision ID: 1c25314e59ed
Revises: 
Create Date: 2024-10-20 21:53:21.915786
...
def upgrade():
    ...
    sa.Column('name', sa.Enum('vendor', 'customer', name='role_type'), nullable=False),
